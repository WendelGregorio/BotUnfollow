...
following_profiles = [el.text for el in driver.find_elements(By.XPATH,"//ul/div/li/div/div/div/div/div/span/a/span")]

#Laço de repetição para Clicar no botão seguindo na lista de contas que estão sendo seguidas
#em seguida clicar em unfollow


for i in range(1):
    #if any(nome in following_profiles[i] for nome in white_list):
        #continue   
